%
%
% This script loads the *.flxdato results generated by running the OnScale
% model niti_guided.flxinp. It then outputs an XT plot and 2D Fourier power
% spectrum, similar to Figures 3c and 3g. 
%
...
if load_precomputed_results
    ...
    flxdato_prefix = 'niti_guided_results';
