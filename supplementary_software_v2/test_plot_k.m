kfit_holder = load('dispersion_curves_subject_6.mat');
kfit_holder = kfit_holder.kfit_holder;
G_opt_holder = load('G_opt_subject_6.mat');
G_opt_holder = G_opt_holder.G_opt_holder;
...
title('Dispersion Curves for Subject 6');
