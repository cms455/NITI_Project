...
load_data = importdata('/Users/calvinsmith/Bouma_lab/NITI_project/Dispersion_Data/550 um thickness/Cornea_NITI_water_mueq100G_fwP.txt');
data = load_data.data;
...
for i = 1:num_freq
    [~, idx] = min(abs(f - select_freq(i)));  % Find the index of the closest frequency
    f_reduced(i) = idx;  % Assign the closest frequency to f_reduced
end
% Display the selected frequencies
disp(f_reduced);
